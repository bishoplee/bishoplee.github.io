...
!function (t, e) {
    ...
    let o = null, s = "ontouchstart" in t || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
        u = s ? "touchstart" : "mousedown", a = s ? "touchcancel" : "mouseout", i = s ? "touchend" : "mouseup";
    "initCustomEvent" in e.createEvent("CustomEvent") && (t.CustomEvent = function (t, n) {
        n = n || {bubbles: !1, cancelable: !1, detail: void 0};
        let o = e.createEvent("CustomEvent");
        ...
        const e = t.target, s = parseInt(e.getAttribute("data-long-press-delay") || "1500", 10);
